...
void laser_ctrl_Mode::CanRecv1_driverCall(const std_msgs::String::ConstPtr& msg)
{
	std::string recvstr = msg->data;
	
	message recvmsg(recvstr);
	if((recvmsg.get_fram_ID()&0x000000ff)==(int)DEV_DIR_ADD_LF){

			char * pd = recvmsg.get_fram_data();
			 switch((unsigned char)pd[1]){
                           	case 0xCA:
					LF_counter= recvmsg.get_data_m_param23();
	...
	else if((recvmsg.get_fram_ID()&0x000000ff)==(int)DEV_DIR_ADD_LB){

			char * pd = recvmsg.get_fram_data();
			 switch((unsigned char)pd[1]){
                           	case 0xCA:
					LB_counter= recvmsg.get_data_m_param23();
...
void laser_ctrl_Mode::CanRecv2_driverCall(const std_msgs::String::ConstPtr& msg)
{
	std::string recvstr = msg->data;
	
	message recvmsg(recvstr);
	if((recvmsg.get_fram_ID()&0x000000ff)==(int)DEV_DIR_ADD_RF){

			char * pd = recvmsg.get_fram_data();
			 switch((unsigned char)pd[1]){
                           	case 0xCA:
					RF_counter= recvmsg.get_data_m_param23();
	...
	if((recvmsg.get_fram_ID()&0x000000ff)==(int)DEV_DIR_ADD_RB){

			char * pd = recvmsg.get_fram_data();
			 switch((unsigned char)pd[1]){
                           	case 0xCA:
					RB_counter= recvmsg.get_data_m_param23();
