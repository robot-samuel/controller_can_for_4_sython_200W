...
#include "ultrasonicMode.hpp.hpp"
#include "zmqclient.h"
...
//参数打印
	...
	ultrasonicSensorMode ultrasonicSensor(COM,badrate);
	// pub 
	BmsSensor.BmsInfopub = handel->advertise<std_msgs::String>("UltrasonicInfo", 10);


        boost::thread t1(boost::bind(&ultrasonicSensorMode::ultrasonicSensorMode_master,&BmsSensor));  
