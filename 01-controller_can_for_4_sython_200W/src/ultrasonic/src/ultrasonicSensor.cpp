...
ultrasonicSensor::ultrasonicSensor(unsigned char add)
    :m_add(add)
{
	MyMemclear((void *)&BmsOrgInfo,sizeof(struct _BmsWork));
}
...
void ultrasonicSensor::MyMemclear(const void *src,int count)   
{   
...
std::string ultrasonicSensor::Cmd_GetInfo()
{
...
void ultrasonicSensor::Set_add(unsigned char  add)
{
	m_add = add;
 }

unsigned char ultrasonicSensor::add()
{
	return m_add;
 }
...
void ultrasonicSensor::print_hex(unsigned char * data)
{

	std::cout<< "ultrasonicSensor_cmd:print_hex:";
...
void ultrasonicSensor::print_hex(std::string &data)
{
	#if DEBUG_ECHO
	int Num = data.size();
	std::cout<< "ultrasonicSensor_cmd:print_hex:";
...
unsigned short ultrasonicSensor::getCRC(unsigned char *p,int num){    	
	//unsigned char *p = m_Afram_data.c_array();	
...
int ultrasonicSensor::infocheck(std::string &str){
...
void ultrasonicSensor::recordInfo(std::string &str){
...
void ultrasonicSensor::printMsg(void){

	std::cout<< "ultrasonicSensor_recv:print_hex:";
