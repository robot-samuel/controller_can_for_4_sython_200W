...
public:
	...
	//Ph3ModeInfo
	OnlineLogMessage Ph3SysNode;
	ph3airmsg Ph3ModeInfo;
	...
	int CheckAlarm_Ph3ReadNodeNdeOFF();
	int CheckAlarm_Ph3ReadComLost();
	void CheckAlarm();
	...
	void record_ExternModeInfo(std::string & str);
