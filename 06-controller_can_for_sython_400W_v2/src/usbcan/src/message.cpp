...
void message::set_fram_ID(unsigned  int id){
...
unsigned  int message::get_fram_ID(){
...
std::cout<<"\n";
 ...
 void message::set_data_m_param1(unsigned short int para){
        this->m_param1 =para;
 ...
 void message::set_data_m_param2(unsigned short int para){
         this->m_param2 =para;
 ...
 void message::set_data_m_param3(unsigned short int para){
         this->m_param3 =para;
 ...
 void message::set_data_m_param4(unsigned short int para){
         this->m_param4 =para;
...
void message::set_data_m_param34(int data){
...
void message::getPRIMcheck(){
        ...
        unsigned short int sdata1=get_data_m_param1();
        unsigned short int sdata2=get_data_m_param2();
        unsigned short int sdata3=get_data_m_param3();
        
        unsigned short int sdata4 = sdata1^sdata2;
        sdata4 ^=sdata3;
        
        set_data_m_param4(sdata4);
    }

 void message::Set_CMD(  int cmd){	
