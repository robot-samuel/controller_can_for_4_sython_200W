...
//参数打印
	...
	*/
	...
	//ros::Subscriber rossub_Can1Recv = handel->subscribe("Can1Recv", 60, &laser_ctrl_Mode::CanRecv1_driverCall,&LCCom);


	//ROS_INFO("LaserCtrlNode   Initialization rossub_CanRecv  Can1Recv    is ok"); 	

	//ros::Subscriber rossub_Can2Recv = handel->subscribe("Can2Recv", 60, &laser_ctrl_Mode::CanRecv2_driverCall,&LCCom);

	//ROS_INFO("LaserCtrlNode   Initialization rossub_CanRecv  Can2Recv    is ok"); 
